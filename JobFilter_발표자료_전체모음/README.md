...
## 라이브 서비스
https://jobfilter-woad.vercel.app

## 현재 상태
- 실 서비스 운영 중 (2026.05.22 ~)
- 등록 공고 48개
- 안산대학교 컴퓨터정보과 · 인공지능소프트웨어과 대상

## 발표 자료 구조

이 폴더는 발표 및 분석 자료를 다음과 같이 정리합니다.

| 폴더 | 내용 |
|------|------|
| `01_최종_보고서/` | 최종 주간 보고서 HTML (`JobFilter_디렉터리분석_발표.html`) |
| `02_원고_및_분석/` | 발표 원고, 기능 분석, 개선·삭제·추가 계획서 TXT |
| `03_시각자료/` | 통합 커맨드 센터 PDF 및 PNG 시각 자료 |
| `04_과거_기록/` | 7월 작업 보고서, 작업 일지, 추천 기능 기록 |

- **최종 보고서 보기**: `01_최종_보고서/JobFilter_디렉터리분석_발표.html`
- **발표 원고 참고**: `02_원고_및_분석/JobFilter_발표자료_전체모음_최종통합정리.txt`
